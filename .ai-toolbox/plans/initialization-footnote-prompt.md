...
## Target Files
- .ai-toolbox/commands/initialization.md — modify — Step 6 "Apply Extension Identity" gains the footnote target (the description is already collected in Step 2)
...
## Prior Art in Repo
- .ai-toolbox/commands/initialization.md Step 2 — already collects "Description: What does this extension do?"; no new prompt needed, only a new application target in Step 6
